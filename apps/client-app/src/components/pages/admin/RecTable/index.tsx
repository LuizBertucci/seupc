...
useEffect(() => {
  ...
  return (
    <>
<div className="w-1/2" >
<DataTable title="Sites de Recomendação" setRowSelection={setRowSelection} rowSelection={rowSelection} columns={columns || []} data={dataTable || []} rightMenu={ <OptionsTable setRowSelection={setRowSelection} rowSelection={rowSelection} /> } className="w-full" />
      </div>
    </>
  )
}
