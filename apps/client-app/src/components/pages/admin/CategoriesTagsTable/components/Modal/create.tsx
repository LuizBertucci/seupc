...
export default function CreateCategoriesTags({ edit, editValues, editIndex }: { edit?: boolean, editValues?: CategoryTags, editIndex?: number }) {
  ...
  return (
    ...
    <Input formError={errors?.category?.message} {...register("category", { required: "Nome para o tipo obrigatório", maxLength: { value: 100, message: "Tamanho máximo do nome ultrapassado" } }) } placeholder='Nome da Categoria' />
