...
import CreateTags from '../Modal/create'
import DeleteTags from '../Modal/delete'
...
<Modal content={<DeleteTags selected={Object.keys(rowSelection)[0]} setRowSelection={setRowSelection} />} >
<ActionButton icon={faTrash} disabled={Object.keys(rowSelection).length !== 1} />
</Modal>

<Modal content={<CreateTags edit={true} editValues={dataTable?.[Object.keys(rowSelection)[0]]} editIndex={Number(Object.keys(rowSelection)[0])} />} >
<ActionButton icon={faPen} disabled={Object.keys(rowSelection).length !== 1} />
</Modal>

<Modal content={<CreateTags />}  >
